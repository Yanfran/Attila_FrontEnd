...
const Crear = () => {
  ...
  const [empleado, setEmpleado] = useState({ nombre: "", codigo_empleado: "", sede: "", status: "",  clave: "" });
  ...
  const Guardar = (e) => {
    ...
    if (empleado.nombre == "" ||  empleado.codigo_empleado == "" ||  empleado.clave == "" || empleado.sede == "" || empleado.status == "") {
    ...
    form.append("clave", empleado.clave);    
