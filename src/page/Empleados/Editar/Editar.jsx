...
const Editar = () => {  
  ...
  const [editarEmpleado, setEditarEmpleado] = useState({ nombre: "", codigo_empleado: "", sede: "", status: "", clave: "" });
  ...
  const handleEditar  = (e) => {
    ...
    form.append('clave', editarEmpleado.clave);
    form.append('id', id);
        ...
        <Row>
          ...
          <Form onSubmit={handleEditar} className="form">
            ...
            <Row className="mt-5">
              ...
              <Col xs={12} md={4} lg={4}>
              <Form.Control type="hidden" name="clave" value={editarEmpleado.clave} />
                <InputGroup className="mb-3">
                  <InputGroup.Text
                    id="password"
